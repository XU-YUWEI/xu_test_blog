...
public class BlogDetailVO implements Serializable {
	...
	public String toString() {
		return "BlogDetailVO [blogId=" + blogId + ", blogTitle=" + blogTitle + ", blogCategoryId=" + blogCategoryId
				+ ", commentCount=" + commentCount + ", blogCategoryIcon=" + blogCategoryIcon + ", blogCategoryName="
				+ blogCategoryName + ", blogCoverImage=" + blogCoverImage + ", blogViews=" + blogViews + ", blogTags="
				+ blogTags + ", blogContent=" + blogContent + ", enableComment=" + enableComment + ", createTime="
				+ createTime + "]";
	}
